...
export default class PtoMeters extends Component {
  ...
  render() {
    ...
    var KG = 1.989* Math.pow(10, 30);
    var tonne =1.989* Math.pow(10, 27);
      ...
      <TouchableWithoutFeedback onPress={() => {
        ...
        <ScrollView style={globalStyles.pageContainer}>
          ...
          <View>
            ...
            <View>
              <Text style={globalStyles.pageTitle}>convert Solar Mass</Text>
            </View>
            ...
            {<Text style={globalStyles.cardStuff}>  {f1} Solar Mass euqals:  {(f1 * KG).toFixed(3)} KG </Text>}
            {<Text style={globalStyles.cardStuff}>  {f1} Solar Mass euqals:   {(f1 * tonne).toFixed(3)} tonne </Text>}
